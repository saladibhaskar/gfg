<h2><a href="https://www.geeksforgeeks.org/problems/full-prime2659/1?page=1&status=attempted&sortBy=submissions">Full Prime</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N.Check if it is Full Prime or not.&nbsp;<br>
